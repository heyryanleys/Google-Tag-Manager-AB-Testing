...
var changes = {
  2: {
        variants: {
            0: {
                execute: function () {
					document.getElementsByClassName("einspaltig")[0].style.font = "50px Roboto, sans-serif";
          document.getElementsByClassName("einspaltig")[0].innerHTML = "<center>Register for the tech talk!</center>"
                }
            },
            1: {
                execute: function () {
					document.getElementsByClassName("einspaltig")[0].style.font = "50px Roboto, sans-serif";
          document.getElementsByClassName("einspaltig")[0].innerHTML = "<center>Your tech talk awaits!</center>"
                }
            }
        }
    }
